...
export default function Cart({ items, onRemove, onClose, onUpdateQty }) {
  const total = items.reduce((sum, item) => sum + item.price * item.qty, 0); // fix 6 - calculate price based on quantity
                  ...
                  <div className="cart-item-info">
                    ...
                    <div className="cart-item-controls">
                      <button
                        ...
                        disabled={item.qty <= 1} //bug fix 7 - disable decrement button at qty 1
                      >−</button>
